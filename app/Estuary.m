...
%      
    properties (Hidden)
        ...
        PropertyLabels = {'Coarse Fraction equilibirum dry density (kg/m^3)',...
                          'Fine Fraction equilibirum dry density (kg/m^3)',...
    ...
    properties
        EqRhoCoarse = 0          %coarse fraction equilibrium dry density (kg/m^3)
        EqRhoFine = 0            %fine fraction equilibrium dry density (kg/m^3)
